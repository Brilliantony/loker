                            ...
                            <div class="kt-login__signin">
                                    ...
                                    @csrf
                                        <div class="input-group">
                                            <input class="form-control" type="text" placeholder="Nama" name="name" id="name">
                                        </div>
                                        <div class="input-group">
                                            <div class="form-control">
                                            <label for="">Upload Photo</label>
                                            <input  type="file" placeholder="Photo Profil" name="photo" id="photo">
                                            </div>   
                                        </div>
                                        <div class="input-group">
                                            <input class="form-control" type="text" placeholder="Nama Panggilan" name="nick_name" id="nick_name">
                                        </div>
                                        <div class="input-group">
                                            <input class="form-control" type="text" placeholder="SMA/SMK/D3/S1" name="level" id="level">
                                        </div>
                                        <div class="input-group">
                                            <input class="form-control" type="text" placeholder="Jurusan" name="majors_id" id="majors_id">
                                        </div>
                                        <div class="input-group">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" type="text" placeholder="telp" name="telp" id="telp">
                                        </div>
                                        <div class="input-group">
                                            <input class="form-control" type="text" placeholder="Tanggal Lahir" name="birth_date" id="birth_date">
                                        </div>
